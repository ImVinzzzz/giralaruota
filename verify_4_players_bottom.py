...
async def run():
    async with async_playwright() as p:
        ...
        await page.select_option("#player-count", "4")
        ...
        # Scroll to the bottom to see scores
        await page.evaluate("window.scrollTo(0, document.body.scrollHeight)")
        await page.wait_for_timeout(1000)

        # Take a screenshot of the main game layout with 4 players
        await page.screenshot(path="mobile_4_players_layout_bottom.png", full_page=True)
